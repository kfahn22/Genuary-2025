...
let ruleChoices = ["kolam", "kolam"];
let shapeChoices = ["Knot", "Astroid"];
// let strokeChoices = ["terracotta", "brown"];
// let fillChoices = ["terracotta", "white"];
let strokeChoices = ["rose2", "gray"];
let fillChoices = ["rose2", "white"];
